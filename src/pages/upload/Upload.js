...
function Upload(props) {
  ...
  useEffect(() => {
    axios
      .get('https://port-0-ping-backend-mkvwe63p223f9070.sel3.cloudtype.app/api/categories')
      .then(res => {
  ...
  //       'https://port-0-ping-backend-mkvwe63p223f9070.sel3.cloudtype.app/api/posts',
  //       formData,
  //       {
  //         headers: {
